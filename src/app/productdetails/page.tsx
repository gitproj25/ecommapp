...
//               <div className="flex items-center bg-gray-100 rounded-full py-0 px-7 lg:px-12 lg:py-2">
...
//     router.push("/cart");
//   }}
//   className="w-[clamp(140px,60%,300px)] text-[clamp(0.8rem,1vw,1rem)] lg:text-[clamp(0.8rem,1.8vw,1rem)] lg:w-full  bg-black text-white py-2 rounded-full font-semibold "
// >
//   Add to Cart
// </button>
