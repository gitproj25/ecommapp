...
export default function NewArrivals() {
  ...
  passHref
>
 <button className="  border border-gray-300 font-Satoshi font-Regular text-black px-8 py-3 rounded-full hover:bg-gray-100 transition-colors duration-300 
   w-full  sm:w-[220px]  ">
    View All
  </button>
</Link>
  ...
  return (
    <div className="bg-white rounded-lg overflow-hidden">
      ...
      <div className="p-3 flex flex-col items-start text-left h-[7rem] sm:h-36">
        <h3 className="text-[clamp(0.9rem,2.2vw,1.2rem)] leading-[1] font-Satoshi font-Medium   w-full  h-[1.3rem] sm:h-[1.2rem] md:h-[1.9rem]">
          {product.name}
        </h3>
...
<span className="font-Satoshi text-gray-500 font-light ml-1">/5</span>
        ...
        <div className="mt-4 h-[1.5rem] sm:h-[2rem] md:h-[1.9rem] flex items-center gap-2 font-Satoshi font-bold ">
          {product.oldPrice ? (
            <>
              ...
              <span className="bg-red-100 text-red-500 font-Satoshi font-Regular px-3 py-1 rounded-full text-[clamp(0.4rem,2vw,0.8rem)] ">
                {Math.round(
